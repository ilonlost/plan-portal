...
Для версии от 08.09.2026 проверьте `APP_ENV=production`, `AUTH_MODE=ldap` и собственный
`SESSION_SECRET` (не менее 32 символов). Миграция `20260908_0010` отключает
...
Если ранняя версия проекта остановилась с ошибкой `relation ... already exists`,
обновите код и повторно запустите эту же команду. Миграции совместимы с уже
созданными таблицами и не удаляют данные.
