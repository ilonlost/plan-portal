...
class User(Base):
    ...
    section_permissions: Mapped[dict] = mapped_column(JSON, default=dict, server_default="{}")
...
class Product(Base):
    ...
    fk_status: Mapped[str | None] = mapped_column(String(120))
...
class DemandItem(Base):
    ...
    quantity_kg: Mapped[Decimal | None] = mapped_column(Numeric(18, 6))
