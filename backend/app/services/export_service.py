...
class ExcelExportService:
    HEADERS = [
        ...
        "Количество источника", "Ед. источника", "Задание, кг", "Коробов", "Квантов",
    ...
    def build(self, items: list[dict]) -> bytes:
        ...
        for item in items:
            sheet.append([
                ...
                self._float(item.get("quantity_kg") or item.get("quantity")), self._float(item.get("box_count")),
        ...
        widths = [14, 10, 24, 16, 30, 16, 20, 14, 16, 12, 12, 14, 20, 30, 16, 14, 44]
